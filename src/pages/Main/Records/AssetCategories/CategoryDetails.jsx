...
import { updateCategory, deleteCategory } from "../../../../firebase/categoryservices";
        ...
        >
            ...
            <div className="record-form">
                <div className="record-form-group">
                    ...
                    <input type="text" value={selectedCategory.description || ""} onChange={(e) => setSelectedCategory({ ...selectedCategory, description: e.target.value })} />
                </div>
            </div>
        </ModalDetails>
    );
